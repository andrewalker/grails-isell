...
<html>
	...
	<body>
		...
		<div id="edit-shoppingOrder" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${shoppingOrderInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${shoppingOrderInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:shoppingOrderInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${shoppingOrderInstance?.version}" />
				<fieldset class="form">
