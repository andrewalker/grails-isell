	...
	<body>
		...
		<div id="show-product" class="content scaffold-show" role="main">
			...
			<ol class="property-list product">
				...
				<g:if test="${productInstance?.amountInStock}">
				<li class="fieldcontain">
					<span id="amountInStock-label" class="property-label"><g:message code="product.amountInStock.label" default="Amount In Stock" /></span>
					
						<span class="property-value" aria-labelledby="amountInStock-label"><g:fieldValue bean="${productInstance}" field="amountInStock"/></span>
				...
				<g:if test="${productInstance?.orders}">
				<li class="fieldcontain">
					<span id="orders-label" class="property-label"><g:message code="product.orders.label" default="Orders" /></span>
				...
				<g:if test="${productInstance?.year}">
				<li class="fieldcontain">
					<span id="year-label" class="property-label"><g:message code="product.year.label" default="Year" /></span>
					
						<span class="property-value" aria-labelledby="year-label"><g:fieldValue bean="${productInstance}" field="year"/></span>
