		...
		<div id="list-product" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="amountInStock" title="${message(code: 'product.amountInStock.label', default: 'Amount In Stock')}" />
						...
						<g:sortableColumn property="year" title="${message(code: 'product.year.label', default: 'Year')}" />
				...
				<g:each in="${productInstanceList}" status="i" var="productInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: productInstance, field: "amountInStock")}</td>
						...
						<td>${fieldValue(bean: productInstance, field: "year")}</td>
